...
function _lgam_as_r7(x::Float64, c::Vector{Float64})::Float64
    return ((x - c[1]) * (x - c[2])) * ((x - c[3]) * (x - c[4])) * (((x - c[5]) * (x - c[6])) * (x - c[7]))
end

function _lgam_as_r8(x::Float64, c::Vector{Float64})::Float64
...
# Examples
```jldoctest
julia> cr_lgamma(2.0f0)
0.0f0
```

# Reference:
- [IEEEX754-2019](https://ieeexplore.ieee.org/document/8683059)
"""
