...
if "cr_tanpi.fast" in CheckExhaustive
    @testset "cr_tanpi-exhaustive.fast" begin
        test_float_range(tanpi, PureLibm.cr_tanpi, F32_POS_FINITE_RANGE)
        test_float_range(tanpi, PureLibm.cr_tanpi, F32_NEG_FINITE_RANGE)
    end
end
if "cr_tanpi" in CheckExhaustive
    @testset "cr_tanpi-exhaustive" begin
        test_float_range(tanpi, PureLibm.cr_tanpi, F32_POS_FINITE_RANGE, bigfloat=true)
        test_float_range(tanpi, PureLibm.cr_tanpi, F32_NEG_FINITE_RANGE, bigfloat=true)
    end
end
