...
if "cr_asinh.fast" in CheckExhaustive
    @testset "cr_asinh-exhaustive.fast" begin
        test_float_range(asinh, PureLibm.cr_asinh, F32_POS_FINITE_RANGE)
        test_float_range(asinh, PureLibm.cr_asinh, F32_NEG_FINITE_RANGE)
    end
end
if "cr_asinh" in CheckExhaustive
    @testset "cr_asinh-exhaustive" begin
        test_float_range(asinh, PureLibm.cr_asinh, F32_POS_FINITE_RANGE, bigfloat=true)
        test_float_range(asinh, PureLibm.cr_asinh, F32_NEG_FINITE_RANGE, bigfloat=true)
    end
end
