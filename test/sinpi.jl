...
if "cr_sinpi.fast" in CheckExhaustive
    @testset "cr_sinpi-exhaustive.fast" begin
        test_float_range(sinpi, PureLibm.cr_sinpi, F32_POS_FINITE_RANGE)
        test_float_range(sinpi, PureLibm.cr_sinpi, F32_NEG_FINITE_RANGE)
    end
end
if "cr_sinpi" in CheckExhaustive
    @testset "cr_sinpi-exhaustive" begin
        test_float_range(sinpi, PureLibm.cr_sinpi, F32_POS_FINITE_RANGE, bigfloat=true)
        test_float_range(sinpi, PureLibm.cr_sinpi, F32_NEG_FINITE_RANGE, bigfloat=true)
    end
end
